            ...
            <div className='container'>
                ...
                <div className='row mt-5'>
                    <div className='col-sm-12 col-md-4 landing-card'>
                        <div className="card m-1">
                            <div className="card-body">
                                <h5 className="card-title">John Story</h5>
                                <p className="card-text">"Me and Co-workers went dining. Foot was great. Bill was
                                    $$$$!!!!
                                    Kumar paid, but we split it all later. Thanks to Group Billz!" </p>
                    ...
                    <div className='col-md-4 col-sm-12 landing-card'>
                        <div className="card  m-1">
                            <div className="card-body">
                                <h5 className="card-title">Jules Story</h5>
                                <p className="card-text">"Went to Vegas, party all night, used group billz to
                                    split after. Easy and fair. Food, gas, you name it."</p>
                                <a href="#" className="card-link">Learn More >></a>
                            </div>
                        </div>
                    </div>
